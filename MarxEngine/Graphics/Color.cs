...
namespace Nexus.Framework.Graphics
{
	...
	public struct Color : IEquatable<Color>
    {
        ...
        public float R
        {
            get => Convert.ToSingle(_r / 255);
            set => _r = value;
        }

        public float G
        {
            get => Convert.ToSingle(_g / 255);
            set => _g = value;
        }

        public float B
        {
            get => Convert.ToSingle(_b / 255);
            set => _b = value;
        }

        public float A
        {
            get => Convert.ToSingle(_a / 255);
            set => _a = value;
        }
        ...
        {
            return Equals(_r, other._r) && Equals(_g, other._g) && Equals(_b, other._b) && Equals(_a, other._a);
        }
